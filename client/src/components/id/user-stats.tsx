          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-blue-700">Начните работу с Aurora Rise</div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
              <div>
                <div className="font-medium text-purple-900">Опубликовать пост в Aurora Volt</div>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-green-700">Покажите себя в Pragma Aurora</div>
              </div>
