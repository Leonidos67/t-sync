          ...
          <div className="bg-background flex min-h-12 w-full flex-wrap items-center gap-1 rounded-xl border p-2">
            {selectedTag?.map((tag) => (
              <motion.div
                key={tag}
                layout
                className="group bg-primary text-primary-foreground hover:bg-primary/90 flex cursor-pointer flex-row items-center justify-center gap-2 rounded-md border px-2 py-1"
        ...
        <div className="flex flex-wrap items-center gap-1 mt-2">
          {tags.map((tag, index) => (
            <motion.div
              layout
              key={index}
              className="group bg-secondary text-secondary-foreground hover:bg-secondary/80 flex cursor-pointer flex-row items-center justify-center gap-2 rounded-md border px-2 py-1"
